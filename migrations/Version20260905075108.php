 ...
 */
final class Version20260905075108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, date_prevue DATETIME NOT NULL, date_realisation DATETIME NOT NULL, commentaire LONGTEXT NOT NULL, materiel_utilise_id INT DEFAULT NULL, equipe_intevention_id INT DEFAULT NULL, INDEX IDX_D11814ABB9EDE018 (materiel_utilise_id), INDEX IDX_D11814AB374E7C6A (equipe_intevention_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, is_active TINYINT NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
